...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        System.out.println("Split fifty point between attack level and defense level");
        ...
        int dlMax = MAX_HIT_POINTS - al;
        System.out.println("Enter your defense level (1-" + dlMax + "): ");
        int dl = myScan.nextInt();
        while (dl <= 0 || dl > dlMax) {
            System.out.println("Sorry. The defense level must be between 1 and " + dlMax + ": ");
            dl = myScan.nextInt();
        }
